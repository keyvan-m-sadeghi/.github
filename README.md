...
| **Docs/Communication**     | 95%       | Exceptional ability to document and explain. Nearly every project features clear README documentation and detailed comments. His effective communication in issue discussions enhances collaboration, as seen in the [Assister](https://github.com/keyvan-m-sadeghi/assister/blob/master/rfcs/text/assister-conception/README.md) repository.                                                                                |
